...
const getJSONFromCsv = require("../../../../test-config/get-json-from-csv/getJSONFromCsv.js")("test-config/dummy-data-csv-files/cypher-queries/relationships/AcceptedFriendRequestRelationshipQueries/createAcceptedFriendRequestRelationshipBetweenUsers");
const createTestObject = require("../../../../test-config/create-test-object/createTestObject.js");
const LoadDummyDataToNeo4j = require("./../../../../test-config/load-dumy-data-to-neo4j/loadDummyDataToNeo4j.js");
const csvFilesPath = "cypher-queries/relationships/AcceptedFriendRequestRelationshipQueries/createAcceptedFriendRequestRelationshipBetweenUsers";

const loadDummyDataToNeo4j = new LoadDummyDataToNeo4j(driver, csvFilesPath);

describe("Testing create accepted friend request relationship between users query", () => {
    ...
    it("create accepted friend request relationship between users query", () => {
        return getJSONFromCsv
            .then(async ({
                ...
                _.forEach(dummySentFriendRequestRelationshipsData, async function (dummySentFriendRequestRelationship, i) {
                    await executeQuery(acceptedFriendRequestRelationshipQueries.createAcceptedFriendRequestRelationshipBetweenUsers.query, acceptedFriendRequestRelationshipQueries.createAcceptedFriendRequestRelationshipBetweenUsers.params(dummySentFriendRequestRelationship.id))
                        .then(async (records) => {
