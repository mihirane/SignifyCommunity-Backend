...
const getJSONFromCsv = require("../../../../test-config/get-json-from-csv/getJSONFromCsv.js")("test-config/dummy-data-csv-files/cypher-queries/nodes/UserQueries/updateProfileImageOfUser");
const createTestObject = require("../../../../test-config/create-test-object/createTestObject.js");
const LoadDummyDataToNeo4j = require("./../../../../test-config/load-dumy-data-to-neo4j/loadDummyDataToNeo4j.js");
const csvFilesPath = "cypher-queries/nodes/UserQueries/updateProfileImageOfUser";
        ...
        return getJSONFromCsv
            .then(async ({
                ...
                await _.forEach(dummyUsersData, async function (dummyUser, i) {
                    await executeQuery(userQueries.updateProfileImageOfUser.query, userQueries.updateProfileImageOfUser.params(dummyUser.recentFacebookAccessToken, "cool profile pic"))
                        .then(async (records) => {
                            ...
                            await assert.deepStrictEqual(recordsTestObject.profileImageUrl, "cool profile pic");
                        })
                        .catch(error => {
                            console.log(error);
                        });
