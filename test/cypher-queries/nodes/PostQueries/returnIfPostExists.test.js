...
const getJSONFromCsv = require("../../../../test-config/get-json-from-csv/getJSONFromCsv.js")("test-config/dummy-data-csv-files/cypher-queries/nodes/PostQueries/returnIfPostExists");
const createTestObject = require("../../../../test-config/create-test-object/createTestObject.js");
const LoadDummyDataToNeo4j = require("./../../../../test-config/load-dumy-data-to-neo4j/loadDummyDataToNeo4j.js");
const csvFilesPath = "cypher-queries/nodes/PostQueries/returnIfPostExists";

const loadDummyDataToNeo4j = new LoadDummyDataToNeo4j(driver, csvFilesPath);

describe("Testing return if post exists query", () => {
    ...
    it("return if post exists query", () => {
        return getJSONFromCsv
            .then(async ({
                ...
                await _.forEach(dummyPostsData, async function (dummyPost, i) {
                    await executeQuery(postQueries.returnIfPostExists.query, postQueries.returnIfPostExists.params(dummyPost.id))
                        .then(async (records) => {
